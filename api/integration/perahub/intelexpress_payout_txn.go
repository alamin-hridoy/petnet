...
type IEPayoutResponse struct {
	Code    json.Number    `json:"code"`
	Message string         `json:"message"`
	Result  IEPayoutResult `json:"result"`
	RemcoID json.Number    `json:"remco_id"`
}

type IEPayoutResult struct {
...
func (s *Svc) IEPayout(ctx context.Context, sr IEPayoutRequest) (*IEPayoutResponse, error) {
	res, err := s.postNonex(ctx, s.nonexURL("intelexpress/payout"), sr)
	if err != nil {
		return nil, err
	}

	IERes := &IEPayoutResponse{}
