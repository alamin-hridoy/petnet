...
// StreamServerInterceptor will create metrics for each grpc request about how long
// it takes to handle a request. This will create a metrics based on the grpc method.
func StreamServerInterceptor() grpc.StreamServerInterceptor {
	return func(srv interface{}, ss grpc.ServerStream, info *grpc.StreamServerInfo, handler grpc.StreamHandler) error {
		...
		// Gauge how long it took to handle the request.
		defaultClient.GaugeInt64("grpc_stream_"+strings.ToLower(method), int64(timeSince), labels)
