...
func DefaultConfig() (*viper.Viper, error) { return ConfigFile("env/config") }
func ConfigFile(filename string) (*viper.Viper, error) {
	if filename == "" {
...
func WithTimeout(to time.Duration) Option { return func(conf *Config) { conf.writeTimeout = to } }
