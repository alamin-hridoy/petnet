...
func (s *Svc) RejectUploadSvcRequest(ctx context.Context, req *spb.RejectUploadSvcRequestRequest) (*emptypb.Empty, error) {
	...
	if err := s.st.RejectUploadSvcRequest(ctx, storage.UploadServiceRequest{
		OrgID:    req.GetOrgID(),
