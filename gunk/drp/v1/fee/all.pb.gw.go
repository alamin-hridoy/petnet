...
func request_FeeService_FeeInquiry_0(ctx context.Context, marshaler runtime.Marshaler, client FeeServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq FeeInquiryRequest
	...
	msg, err := client.FeeInquiry(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err
}

func local_request_FeeService_FeeInquiry_0(ctx context.Context, marshaler runtime.Marshaler, server FeeServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq FeeInquiryRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.FeeInquiry(ctx, &protoReq)
	return msg, metadata, err
}
...
func RegisterFeeServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server FeeServiceServer) error {
	mux.Handle("POST", pattern_FeeService_FeeInquiry_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/fee.FeeService/FeeInquiry")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_FeeService_FeeInquiry_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_FeeService_FeeInquiry_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	})
...
func RegisterFeeServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client FeeServiceClient) error {
	mux.Handle("POST", pattern_FeeService_FeeInquiry_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/fee.FeeService/FeeInquiry")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_FeeService_FeeInquiry_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var pattern_FeeService_FeeInquiry_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"v1", "fee", "RemitPartner", "inquiry"}, ""))

var forward_FeeService_FeeInquiry_0 = runtime.ForwardResponseMessage
