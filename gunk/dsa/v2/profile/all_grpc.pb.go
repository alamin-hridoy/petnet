...
type OrgProfileServiceClient interface {
	...
	GetProfileByDsaCode(ctx context.Context, in *GetProfileByDsaCodeRequest, opts ...grpc.CallOption) (*GetProfileByDsaCodeResponse, error)
	// List org profiles.
	ListProfiles(ctx context.Context, in *ListProfilesRequest, opts ...grpc.CallOption) (*ListProfilesResponse, error)
	// Update org profile UserID.
	UpdateOrgProfileUserID(ctx context.Context, in *UpdateOrgProfileUserIDRequest, opts ...grpc.CallOption) (*UpdateOrgProfileUserIDResponse, error)
}
...
func (c *orgProfileServiceClient) UpsertProfile(ctx context.Context, in *UpsertProfileRequest, opts ...grpc.CallOption) (*UpsertProfileResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/petnet.v2.profile.OrgProfileService/UpsertProfile", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orgProfileServiceClient) GetProfile(ctx context.Context, in *GetProfileRequest, opts ...grpc.CallOption) (*GetProfileResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/petnet.v2.profile.OrgProfileService/GetProfile", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orgProfileServiceClient) GetProfileByDsaCode(ctx context.Context, in *GetProfileByDsaCodeRequest, opts ...grpc.CallOption) (*GetProfileByDsaCodeResponse, error) {
	out := new(GetProfileByDsaCodeResponse)
	err := c.cc.Invoke(ctx, "/petnet.v2.profile.OrgProfileService/GetProfileByDsaCode", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orgProfileServiceClient) ListProfiles(ctx context.Context, in *ListProfilesRequest, opts ...grpc.CallOption) (*ListProfilesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/petnet.v2.profile.OrgProfileService/ListProfiles", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orgProfileServiceClient) UpdateOrgProfileUserID(ctx context.Context, in *UpdateOrgProfileUserIDRequest, opts ...grpc.CallOption) (*UpdateOrgProfileUserIDResponse, error) {
	out := new(UpdateOrgProfileUserIDResponse)
	err := c.cc.Invoke(ctx, "/petnet.v2.profile.OrgProfileService/UpdateOrgProfileUserID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrgProfileServiceServer interface {
	...
	// Get org profile by DsaCode.
	GetProfileByDsaCode(context.Context, *GetProfileByDsaCodeRequest) (*GetProfileByDsaCodeResponse, error)
	// List org profiles.
	ListProfiles(context.Context, *ListProfilesRequest) (*ListProfilesResponse, error)
	// Update org profile UserID.
	UpdateOrgProfileUserID(context.Context, *UpdateOrgProfileUserIDRequest) (*UpdateOrgProfileUserIDResponse, error)
...
func (UnimplementedOrgProfileServiceServer) GetProfileByDsaCode(context.Context, *GetProfileByDsaCodeRequest) (*GetProfileByDsaCodeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetProfileByDsaCode not implemented")
}
...
func (UnimplementedOrgProfileServiceServer) UpdateOrgProfileUserID(context.Context, *UpdateOrgProfileUserIDRequest) (*UpdateOrgProfileUserIDResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateOrgProfileUserID not implemented")
}
...
func _OrgProfileService_UpsertProfile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/petnet.v2.profile.OrgProfileService/UpsertProfile",
	}
...
func _OrgProfileService_GetProfile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/petnet.v2.profile.OrgProfileService/GetProfile",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _OrgProfileService_GetProfileByDsaCode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetProfileByDsaCodeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrgProfileServiceServer).GetProfileByDsaCode(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/petnet.v2.profile.OrgProfileService/GetProfileByDsaCode",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrgProfileServiceServer).GetProfileByDsaCode(ctx, req.(*GetProfileByDsaCodeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _OrgProfileService_ListProfiles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/petnet.v2.profile.OrgProfileService/ListProfiles",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _OrgProfileService_UpdateOrgProfileUserID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateOrgProfileUserIDRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrgProfileServiceServer).UpdateOrgProfileUserID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/petnet.v2.profile.OrgProfileService/UpdateOrgProfileUserID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrgProfileServiceServer).UpdateOrgProfileUserID(ctx, req.(*UpdateOrgProfileUserIDRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var OrgProfileService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "petnet.v2.profile.OrgProfileService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetProfileByDsaCode",
			Handler:    _OrgProfileService_GetProfileByDsaCode_Handler,
		},
		{
		...
		{
			MethodName: "UpdateOrgProfileUserID",
			Handler:    _OrgProfileService_UpdateOrgProfileUserID_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "brank.as/petnet/gunk/dsa/v2/profile/all.proto",
}
