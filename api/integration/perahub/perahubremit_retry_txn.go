...
type PerahubRemitRetryRequest struct {
	ID          int    `json:"id"`
	PartnerCode string `json:"partner_code"`
}

type PerahubRemitRetryResponseBody struct {
	Code    string                  `json:"code"`
	Message string                  `json:"message"`
	Result  PerahubRemitRetryResult `json:"result"`
}

type PerahubRemitRetryResult struct {
	ID                 int                    `json:"id"`
	...
	APIRequest         PerahubRemitAPIRequest `json:"api_request"`
}

type PerahubRemitAPIRequest struct {
	City                       string              `json:"city"`
	Address                    string              `json:"address"`
	Country                    string              `json:"country"`
	IDType                     string              `json:"id_type"`
	...
	APIRequestCurrentAddress   PerahubRemitAddress `json:"current_address"`
	APIRequestPermanentAddress PerahubRemitAddress `json:"permanent_address"`
}
type PerahubRemitAddress struct {
	City     string `json:"city"`
	Country  string `json:"country"`
	Barangay string `json:"barangay"`
	Province string `json:"province"`
...
func (s *Svc) PerahubRemitRetry(ctx context.Context, sr PerahubRemitRetryRequest) (*PerahubRemitRetryResponseBody, error) {
	res, err := s.postNonex(ctx, s.nonexURL("/perahub-remit/payout/retry"), sr)
	if err != nil {
		return nil, err
	}

	PRCRes := &PerahubRemitRetryResponseBody{}
